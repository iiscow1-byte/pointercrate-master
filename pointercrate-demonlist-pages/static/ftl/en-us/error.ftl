...
error-demonlist-demonnotfound = No Challenge with id { $demon-id } found
error-demonlist-demonnotfoundname = No Challenge with name { $demon-name } found
error-demonlist-demonnotfoundposition = No Challenge at position { $demon-position } found
...
error-demonlist-creatorexists = This player is already registered as a creator on this Challenge
...
error-demonlist-invalidposition = Challenge position needs to be greater than or equal to 1 and smaller than or equal to { $maximal }
...
error-demonlist-submitlegacy = You cannot submit records for legacy Challenges
...
error-demonlist-demonnamenotunique = There are multiple Challenges with the given name
...
error-demonlist-ratelimit-add-demon = Please don't spam the button, jonas!